...
(function () {
  ...
  var RADAR_SERIES = [
    ...
    { key: "i6", name: "思路六·全景体系", v: [5, 4, 4, 3, 4] },
    { key: "i7", name: "思路七·哲学解构", v: [4, 2, 3, 3, 5] },
    { key: "i8", name: "思路八·三轴势场", v: [4, 3, 4, 3, 4] },
    { key: "i9", name: "思路九·AI实证", v: [3, 4, 4, 4, 3] }
  ];
  // 热力：九思路 × 五层 覆盖深度（0-5）
  var HEAT_ROWS = [
    ...
    { key: "i6", name: "思路六·全景体系", v: [5, 5, 4, 3, 4] },
    { key: "i7", name: "思路七·哲学解构", v: [5, 5, 3, 2, 3] },
    { key: "i8", name: "思路八·三轴势场", v: [4, 4, 4, 3, 5] },
    { key: "i9", name: "思路九·AI实证", v: [4, 4, 4, 4, 3] }
  ];
